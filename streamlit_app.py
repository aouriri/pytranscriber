...
# Display the NER content here
    ...
    nlp = st.text_area("Text to analyze (Default text can be used but, I'm okay with change.)", DEFAULT_TEXT, height=200)
    nlp.add_pipe('opentapioca')
    doc = spacy_streamlit.process_text(spacy_model, nlp)
